...
export default function FooterSection() {
  ...
  return (
    <div role="contentinfo" className="flex flex-col items-center relative self-stretch w-full bg-[#1a202c] px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-12">
      <div className="flex flex-col items-center gap-8 relative self-stretch w-full max-w-[1920px]">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 w-full">
          <div className="flex flex-col items-start gap-4">
            <div className="font-bold text-[#fdfdfd] text-2xl tracking-[0] leading-[normal]">
              {t("navBrand")}
            </div>
            <p className="text-[#9c9c9d] text-sm max-w-[300px]">
              {t("footerTagline")}
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-12 md:gap-16">
            <div className="flex flex-col items-start gap-4">
              <div className="font-semibold text-[#fdfdfd] text-base">
                {t("footerCompany")}
              </div>
              <div className="flex flex-col items-start gap-2">
                <Link href="/about" className="text-[#9c9c9d] text-sm hover:text-[#fdfdfd]">
                  {t("footerAbout")}
                </Link>
                <a href="#" className="text-[#9c9c9d] text-sm hover:text-[#fdfdfd]">
                  {t("footerCareers")}
                </a>
                <Link href="/contact" className="text-[#9c9c9d] text-sm hover:text-[#fdfdfd]">
                  {t("footerContact")}
                </Link>
              </div>
            </div>
